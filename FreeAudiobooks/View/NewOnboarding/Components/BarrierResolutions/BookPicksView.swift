...
struct BookPicksContent: View {
    ...
    private func imagesForGenre(_ genre: BookInternalGenre?) -> [String] {
        ...
        case .thriller:
            return ["thriller-18", "thriller-15", "thriller-3"]
        case .drama:
            return ["drama-13", "drama-2", "drama-16"]
        case .mystery:
            return ["mystery-13", "mystery-2", "mystery-3"]
        case .fantasy:
            return ["fantasy-11", "fantasy-2", "fantasy-15"]
        case .adventure:
            return ["adventure-12", "adventure-16", "adventure-3"]
        case .historical:
