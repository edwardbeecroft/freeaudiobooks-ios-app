...
extension ShortStoryCarouselTVC {
    struct Layout {
...
class ShortStoryCarouselTVC: UITableViewCell {
    ...
    func configure(with section: DiscoverSection, stories: [CDBookInternal]) {
        ...
        // Apply attributed string if title contains "FreeBooks+"
...
extension ShortStoryCarouselTVC: UICollectionViewDataSource {
...
extension ShortStoryCarouselTVC: UICollectionViewDelegateFlowLayout {
...
extension ShortStoryCarouselTVC: UICollectionViewDelegate {
